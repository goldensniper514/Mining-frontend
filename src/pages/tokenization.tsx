...
import Slider_Panel from "../components/Tokenization/Slider_Panel";
import Slider from "../components/Tokenization/Slider";

const Slider_imgs = [
    "./tokenization/slide1.svg",
    "./tokenization/slide2.svg",
    "./tokenization/slide3.svg",
];
const Tokenization: React.FC = () => {
    ...
    return (
        <div className="w-full  flex flex-col items-center justify-center bg-white box-border overflow-x-hidden">
            {/* ------------section1----------- */}
            <div className="h-[600px] w-[100vw]  bg-[url('../public/tokenization/section1.svg')] inset-0  bg-black/30  bg-blend-overlay  bg-cover bg-center ">
                <div className="w-full h-full flex flex-col items-center justify-center lg:justify-end lg:items-start p-4 backdrop-blur-sm">
                    <div className="w-full h-auto flex flex-col items-center lg:items-start justify-center gap-[10px] text-center font-bungeeinline font-normal lg:px-20 lg:py-[5%] ">
                        ...
                        <div className="text-4xl sm:text-6xl text-[#F8D835] leading-25 uppercase">
                        tokenization
                        </div>
                    </div>
                </div>
